...
public static class Constants {
    ...
    public static readonly string LMNT_SYNTHESIZE_URL = "https://api.lmnt.com/v1/ai/speech";
    public static readonly string LMNT_VOICES_URL = "https://api.lmnt.com/v1/ai/voice/list";
}
